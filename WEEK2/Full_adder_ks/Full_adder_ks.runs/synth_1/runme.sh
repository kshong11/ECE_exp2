...
HD_PWD='C:/Users/ga690/Desktop/HWpractice/Full_adder_ks/Full_adder_ks.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_design.tcl
