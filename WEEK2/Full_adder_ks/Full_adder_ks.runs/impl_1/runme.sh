...
HD_PWD='C:/Users/ga690/Desktop/HWpractice/Full_adder_ks/Full_adder_ks.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_adder_design.tcl -notrace
